...
public class UsuarioService {
    ...
    public String cadastrarUsuario(Usuario usuario) {
        ...
        // Se não vier perfil, define como TECNICO por padrão
    ...
    public Usuario atualizarUsuario(Long id, Usuario usuarioAtualizado) {
        ...
        usuarioExistente.setPerfil(usuarioAtualizado.getPerfil()); // Atualiza o perfil
    ...
    // --- NOVA FUNCIONALIDADE: REDEFINIR SENHA COM BLOQUEIO PARA ADMIN ---
    public void redefinirSenha(String login, String novaSenha) {
        Usuario usuario = repository.findByLogin(login)
                .orElseThrow(() -> new IllegalArgumentException("Usuário não encontrado."));

        // Regra de Ouro: Administrador não altera senha por aqui
