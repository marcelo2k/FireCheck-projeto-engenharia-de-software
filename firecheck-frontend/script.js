            ...
            users.forEach(u => {
                ...
                <div style="margin-bottom:10px; padding:12px; background-color:#f9f9f9; border-left:4px solid ${corPerfil}; border-radius:4px; display:block;">
                    ...
                    <div style="margin-top:8px;">
                        ...
                        <button onclick="delUser(${u.id})" class="btn-danger">Excluir</button>
                    </div>
                </div>`;
            });
        }
             ...
             clients.forEach(c => {
                 ...
                 <div style="margin-bottom:10px; padding:12px; background-color:#f9f9f9; border-left:4px solid #4CAF50; border-radius:4px; display:block;">
                    ...
                    <div style="margin-top:8px;">
                        ...
                        <button onclick="delClient(${c.id})" class="btn-danger">Excluir</button>
                    </div>
                 </div>`;
             });
        }
            ...
            eds.forEach(e => {
                ...
                <div style="margin-bottom:10px; padding:12px; background-color:#f9f9f9; border-left:4px solid #FF9800; border-radius:4px; display:block;">
                    ...
                    <div style="margin-top:8px;">
                        ...
                        <button onclick="delEdif(${e.idEdificacao})" class="btn-danger">Excluir</button>
                    </div>
                </div>`;
            });
        }
            ...
            eqs.forEach(e => {
                ...
                <div style="margin-bottom:10px; padding:12px; background-color:#f9f9f9; border-left:4px solid #E91E63; border-radius:4px; display:block;">
                    ...
                    <div style="margin-top:8px;">
                        ...
                        <button onclick="delEquip(${e.idEquipamento})" class="btn-danger">Excluir</button>
                    </div>
                </div>`;
            });
        }
            ...
            is.forEach(i => {
                ...
                <div style="margin-bottom:10px; padding:12px; background-color:#f9f9f9; border-left:4px solid ${corStatus}; border-radius:4px; display:block;">
                    ...
                    <div style="margin-top:8px;">
                        ...
                        <button onclick="delInsp(${i.idInspecao})" class="btn-danger">Excluir</button>
                    </div>
                </div>`;
            });
        }
            ...
            svs.forEach(s => {
                ...
                <div style="margin-bottom:10px; padding:12px; background-color:#f9f9f9; border-left:4px solid #9C27B0; border-radius:4px; display:block;">
                    ...
                    <div style="margin-top:8px;">
                        ...
                        <button onclick="delServ(${s.idServico})" class="btn-danger">Excluir</button>
                    </div>
                </div>`;
            });
        }
...
async function listarOrcamentos() {
    try {
        ...
        if(Array.isArray(os)) os.forEach(o => { 
            ...
            let btns = o.status==='Pendente' ? `<button onclick="recusarOrcamento(${o.idOrcamento})">Recusar</button> <button onclick="delOrc(${o.idOrcamento})" class="btn-danger">Excluir</button>` : ''; 
            div.innerHTML += `
            <div style="margin-bottom:10px; padding:12px; background-color:#f9f9f9; border-left:4px solid ${corStatus}; border-radius:4px; display:block;">
...
async function listarOS() {
    try {
        ...
        if(Array.isArray(oss)) oss.forEach(o => {
            ...
            let btns = (o.statusServico !== 'Concluído' && o.statusServico !== 'Cancelado') ? `<button onclick="concluirOS(${o.idOrdemServico})" style="background-color:#4CAF50;">Concluir OS</button> <button onclick="cancelarOS(${o.idOrdemServico})" class="btn-danger">Cancelar</button>` : '';
            div.innerHTML += `
            <div style="margin-bottom:10px; padding:12px; background-color:#f9f9f9; border-left:4px solid ${corStatus}; border-radius:4px; display:block;">
...
// ============================================================
function abrirModulo(moduloId, botaoElement) {
    // 1. Esconde todos os módulos
    const modulos = document.querySelectorAll('.modulo-tela');
    modulos.forEach(modulo => modulo.style.display = 'none');

    // 2. Mostra o módulo escolhido
    ...
    // 4. Acende o botão que foi clicado
    if(botaoElement) {
        botaoElement.classList.add('active');
    }
}

// Quando a página carregar, abre o Dashboard por padrão e roda as funções iniciais
document.addEventListener('DOMContentLoaded', () => {
    // Abre a tela inicial
    const btnHome = document.getElementById('btnMenuDashboard');
    if(btnHome) abrirModulo('tela-dashboard', btnHome);
